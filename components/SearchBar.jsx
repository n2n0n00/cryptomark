...
const SearchBar = ({
  ...
  useEffect(() => {
    ...
    // whenever using timeouts, clear them at the end
  ...
  return (
    <>
      ...
      <div
        onClick={() => setToggle((prevToggle) => !prevToggle)} // react best practice to use a !previousState directly inside the meaning, doing this : setToggle(!toggle) will cause errors
