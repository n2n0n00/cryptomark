...
const NFTDetails = () => {
  ...
  useEffect(() => {
    ...
    // router.query is an object that contains data about all the properties we are passing in
    setNft(router.query);
  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      <div className="relative flex-1 flexCenter sm:px-4 p-12 border-r md:border-r-0 md:border-b dark:dark-border-nft-black-1 border-nft-gray-1">
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="mt-10 flex flex-col">
          <div className="w-full border-b dark:border-nft-gray-2 border-nft-gray-1 flex flex-row">
        ...
        <div className="flex flex-row sm:flex-col mt-10">
          {currentAccount === nft.seller.toLowerCase() ? (
            <p className="font-poppins dark:text-white text-nft-black-1 text-base font-normal border-gray border p-2">
              You already own NFT!
            </p>
          ) : (
            <Button
